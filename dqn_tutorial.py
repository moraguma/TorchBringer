...
# REPLAY_SIZE is the size of the replay buffer
config = {
    "BATCH_SIZE": 128,
    "GAMMA": 0.99,
    "EPS_START": 0.9,
...
def optimize_model():
    ...
    #
    # Effectively, turns [[s0, a0, s'0, r0], [s1, a1, s'1, r1], ...] into
    # [[s0, s1, ...], [a0, a1, ...], [s'0, s'1, ...], [r0, r1, ...]]
    batch = Transition(*zip(*transitions))

    # Compute a mask of non-final states and concatenate the batch elements
    # (a final state would've been the one after which simulation ended)
    # 
    # Effectively, a list of true if next state is not None and false otherwise
